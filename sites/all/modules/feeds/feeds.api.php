...
/**
 * Example of hook_feeds_existing_entity_id().
 *
 * @param $target
 *   Array of target settings, as defined by the processor or
 *   hook_feeds_processor_targets_alter().
 ...
 *
 * @return
 *   The entity ID of the existing entity, or NULL if there is no existing entity.
 */
function hook_feeds_existing_entity_id($target, $value, $processor, $source, $result) {
  if($entity = my_module_custom_entity_load($value)) {
    return $entity->id;
  }
}
